# Generated by Django 2.0.5 on 2018-07-14 22:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('canal_comercializacao', models.IntegerField(blank=True, choices=[(10, 'Venda para outro produtor'), (20, 'Entrega para frigorífico/açougue'), (30, 'Venda para agentes "atravessadores"'), (40, 'Outros')], null=True, verbose_name='Formas/Canais de Comercialização')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destino_lixo_domestico_nao_organico', models.IntegerField(choices=[(10, 'Espalhado no lote'), (20, 'Queima'), (30, 'Enterra'), (40, "Joga nos cursos d'água"), (50, 'Recicla/reaproveita lixo inorgânico'), (60, 'Deposita a céu aberto no lote'), (999, 'Não se aplica')], verbose_name='42. Qual o destino do lixo doméstico não orgânico?')),
                ('destino_material_organico', models.IntegerField(choices=[(10, 'Uso para alimentação de animais'), (20, 'Faz compostagem'), (30, 'Enterra junto com inorgânico'), (40, 'Deposita a céu aberto no lote'), (999, 'Não se aplica')], verbose_name='43. Qual o destino do material orgânico?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outros', models.CharField(blank=True, max_length=30, null=True, verbose_name='Outros')),
                ('quantidade_produzida_ano', models.IntegerField(verbose_name='Quantidade produzida/ano')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valor', models.DecimalField(decimal_places=2, max_digits=7, verbose_name='Valor R$')),
                ('canal_comercializacao', models.IntegerField(blank=True, choices=[(10, 'Venda direta ao consumidor (de casa em casa)'), (20, 'Venda em feiras'), (30, 'Entrega para supermercados, mercearias, açougues, etc'), (40, 'Venda p/ indústrias, e/ou agroindústrias (laticínios etc'), (50, 'Venda para agentes "atravessadores"'), (60, 'Outros')], null=True, verbose_name='Formas/Canais de Comercialização')),
                ('mercado_institucional', models.IntegerField(blank=True, choices=[(10, 'PAA-CONAB'), (20, 'PAA-Prefeitura / MDS'), (30, 'Alimentação Escolar - PNAE'), (40, 'Biodiesel'), (50, 'Outros')], null=True, verbose_name='Mercado Institucional')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('lote', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='atendimentos_saude', serialize=False, to='core.Lote', verbose_name='Lote')),
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tratamentos_agua', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='tratamentoagua',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='programas_saude', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='programasaude',
            name='modificado_por',
        ...
        migrations.AddField(
            model_name='produto',
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='produtos_origem_animal', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='produto',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='producoes_vegetais', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='producaovegetal',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='producoes_florestais', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='producaoflorestal',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='producoes_animais', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='producaoanimal',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='problemas_ambientais', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='problemaambiental',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='praticas_conservacionistas', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='praticaconservacionista',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='niveis_tecnologicos_producao_animal', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='niveltecnologicoproducaoanimal',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='licenciamentos', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='licenciamentoambiental',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fontes_agua', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='fonteagua',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='estruturas_organizativas', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='estruturaorganizativa',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='estabelecimentos_ensino', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='estabelecimentoensino',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='espacos_disponiveis', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='espacodisponivel',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='descartes_animais', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='descarteanimal',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='creditos_bancarios', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='creditobancario',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='construcoes_lote', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='construcaolote',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bens_produtivos', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='bemprodutivo',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='etnias', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='autodeclaracaoetnia',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='atividades_fisicas', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='atividadefisica',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='atividades_extrativistas', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='atividadeextrativista',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aplicacoes_credito', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='aplicacaocredito',
            name='modificado_por',
