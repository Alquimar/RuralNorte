# Generated by Django 2.0.5 on 2018-08-09 13:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agua_para_animais_plantio', models.IntegerField(blank=True, choices=[(10, "Sim, os animais vão até um curso d'água ou represa"), (20, "Sim, a água é puxada de um curso d'água ou represa"), (30, 'Sim, temos um poço exclusivo para os animais'), (40, 'Sim, é a mesma água que vem para a casa'), (50, 'Não há água para animais'), (60, 'Sim, existe água para plantio(s) irrigado(s)'), (70, 'Não existe água para plantio(s) irrigado(s)'), (80, 'Outros')], null=True, verbose_name='Tem água para os animais / Plantio?')),
                ('outros', models.CharField(blank=True, max_length=50, null=True, verbose_name='Água para animais/plantio (Outros)')),
                ('cadastrado_por', cuser.fields.CurrentUserField(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='core_aguaparaanimaisplantio_cadastrado_por', to=settings.AUTH_USER_MODEL)),
                ('desativado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='core_aguaparaanimaisplantio_desativado_por', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('tipo_aplicacao_credito', models.IntegerField(blank=True, choices=[(10, 'Apoio inicial (antes de 2015)'), (20, 'Apoio inicial I (após 2015)'), (30, 'Apoio inicial II (após 2015)'), (40, 'Fomento'), (50, 'Fomento Mulher'), (60, 'Moradia'), (70, 'PNHR-Minha Casa Minha Vida'), (80, 'Reforma Moradia'), (90, 'PNHR-Reforma')], null=True, verbose_name='Tipo de crédito')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('especificacao', models.IntegerField(blank=True, choices=[(10, 'Açaí(Kg)'), (20, 'Babaçu(Kg)'), (30, 'Buriti(Kg)'), (40, 'Cagaita(Kg)'), (50, 'Murici(Kg)'), (60, 'Pequi(Kg)'), (70, 'Outros')], null=True, verbose_name='Especificação')),
                ('outros', models.CharField(blank=True, max_length=30, null=True, verbose_name='Outros')),
                ('quantidade_frutos_ano', models.IntegerField(blank=True, null=True, verbose_name='Quantidade Colhida / Ano - Fruto(s)')),
                ('quantidade_palmitos_ano', models.IntegerField(blank=True, null=True, verbose_name='Quantidade Colhida / Ano - Palmito(s)')),
                ('valor', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Valor R$/Kg')),
                ('canal_comercializacao', models.IntegerField(blank=True, choices=[(10, '(1) Venda direta ao consumidor (de casa em casa)'), (20, '(2) Venda em feiras'), (30, '(3) Entrega para supermercados, mercearias, açougues, etc'), (40, '(4) Venda p/ indústrias, e/ou agroindústrias (laticínios etc'), (50, '(5) Venda para agentes "atravessadores"'), (60, '(6) Outros')], null=True, verbose_name='Formas/Canais de Comercialização')),
                ('mercado_institucional', models.IntegerField(blank=True, choices=[(10, '(7) PAA-CONAB'), (20, '(8) PAA-Prefeitura / MDS'), (30, '(9) Alimentação Escolar - PNAE'), (40, '(10) Biodiesel'), (50, '(11) Outros')], null=True, verbose_name='Mercado Institucional')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('atividade_fisica', models.IntegerField(blank=True, choices=[(10, 'Futebol'), (20, 'Caminhada/corrida'), (30, 'Nenhuma atividade física'), (40, 'Outros')], null=True, verbose_name='Esporte/atividade física')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('tipo_declaracao_etnia', models.IntegerField(blank=True, choices=[(10, 'Negros'), (20, 'Pardos'), (30, 'Brancos'), (40, 'Índios'), (50, 'Orientais'), (60, 'Outros')], null=True, verbose_name='Etnia')),
                ('outros', models.CharField(blank=True, max_length=30, null=True, verbose_name='Outros')),
                ('quantidade', models.IntegerField(blank=True, null=True, verbose_name='Quantos?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('bem_produtivo', models.IntegerField(blank=True, choices=[(10, 'Trator'), (20, 'Caminhão'), (30, 'Caminhonete'), (40, 'Arado / grade'), (50, 'Plantadeira / adubadeira'), (60, 'Pulverizador "tratorizado"'), (70, 'Carroça ou carro de boi'), (80, 'Arado de tração animal'), (90, 'Triturador'), (100, 'Resfriador de leite'), (110, 'Cochos'), (120, 'Calcariadora'), (130, 'Bomba (pulverizador costal)'), (140, 'Matraca'), (150, 'Brete (vacinação gado)'), (160, 'Roçadeira'), (170, 'Motosserra'), (180, 'Outros')], null=True, verbose_name='Bem produtivo')),
                ('outros', models.CharField(blank=True, max_length=30, null=True, verbose_name='Outros')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('tipo_beneficio', models.IntegerField(blank=True, choices=[(10, 'Aposentadoria por tempo de serviço/idade'), (20, 'Aposentadoria por invalidez'), (30, 'Auxílio maternidade'), (40, 'Bolsa família'), (50, 'Bolsa verde'), (60, 'Outros')], null=True, verbose_name='Benefício')),
                ('outros', models.CharField(blank=True, max_length=30, null=True, verbose_name='Outros')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('construcao_no_lote', models.IntegerField(blank=True, choices=[(10, 'Galpão'), (20, 'Curral'), (30, 'Chiqueiro'), (40, 'Galinheiro'), (50, 'Segunda casa'), (60, 'Represa'), (70, 'Espaço para cultos religiosos'), (80, 'Estabelecimento comercial'), (90, 'Agroindústria'), (100, 'Outros')], null=True, verbose_name='Construção')),
                ('outros', models.CharField(blank=True, max_length=30, null=True, verbose_name='Outros')),
                ('quantidade', models.IntegerField(blank=True, null=True, verbose_name='Quantidade')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('credito_bancario', models.IntegerField(blank=True, choices=[(10, 'Micro Crédito Produtivo (A)'), (20, 'A'), (30, 'A/C'), (40, 'Jovem'), (50, 'Mulher'), (60, 'Recuperação (Complementar)'), (70, 'Outros')], null=True, verbose_name='Tipo de crédito')),
                ('outros', models.CharField(blank=True, max_length=30, null=True, verbose_name='Outros')),
                ('valor', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Valor (R$)')),
                ('adimplente', models.IntegerField(blank=True, choices=[(1, 'Sim'), (0, 'Não')], null=True, verbose_name='Adimplente?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('especificacao', models.IntegerField(blank=True, choices=[(10, 'Touros'), (20, 'Vacas'), (30, 'Novilhas(os) + de 02 anos'), (40, 'Novilhas(os) + de 01 ano'), (50, 'Bezerras(os)'), (60, 'Boi')], null=True, verbose_name='Especificação')),
                ('quantidade_cabecas_consumo', models.IntegerField(blank=True, null=True, verbose_name='Nº de Cabeça(s) - Consumo')),
                ('quantidade_cabecas_comercio', models.IntegerField(blank=True, null=True, verbose_name='Nº de Cabeça(s) - Comércio')),
                ('valor_cabeca', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='R$/Cabeça')),
                ('canal_comercializacao', models.IntegerField(blank=True, choices=[(10, '(1) Venda para outro produtor'), (20, '(2) Entrega para frigorífico/açougue'), (30, '(3) Venda para agentes "atravessadores"'), (40, '(4) Outros')], null=True, verbose_name='Formas/Canais de Comercialização')),
        ...
        migrations.CreateModel(
            name='DestinoLixoDomesticoNaoOrganico',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cadastrado_em', models.DateTimeField(auto_now_add=True, null=True)),
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('destino_lixo_domestico_nao_organico', models.IntegerField(blank=True, choices=[(10, 'Espalhado no lote'), (20, 'Queima'), (30, 'Enterra'), (40, "Joga nos cursos d'água"), (50, 'Recicla/reaproveita lixo inorgânico'), (60, 'Deposita a céu aberto no lote'), (999, 'Não se aplica')], null=True, verbose_name='Destino do lixo doméstico não orgânico')),
                ('cadastrado_por', cuser.fields.CurrentUserField(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='core_destinolixodomesticonaoorganico_cadastrado_por', to=settings.AUTH_USER_MODEL)),
                ('desativado_por', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='core_destinolixodomesticonaoorganico_desativado_por', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('destino_material_organico', models.IntegerField(blank=True, choices=[(10, 'Uso para alimentação de animais'), (20, 'Faz compostagem'), (30, 'Enterra junto com inorgânico'), (40, 'Deposita a céu aberto no lote'), (999, 'Não se aplica')], null=True, verbose_name='Destino do material orgânico')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('tipo_documento', models.IntegerField(blank=True, choices=[(10, 'Contrato de Assentamento'), (20, 'Contrato de Concessão de Uso - CCU'), (30, 'Título Definitivo - não registrado'), (40, 'Título Definitivo - registrado cartório'), (50, 'Matrícula da Propriedade')], null=True, verbose_name='Documento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('espaco_disponivel', models.IntegerField(blank=True, choices=[(10, 'Quadra de esportes'), (20, 'Campo de futebol'), (30, 'Salão de festas'), (40, 'Não possui')], null=True, verbose_name='Espaço disponível')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('estabelecimento_ensino', models.IntegerField(blank=True, choices=[(10, 'Pré-escolar (creche)'), (20, 'Ensino Fundamental'), (30, 'EJA'), (40, 'Ensino Médio'), (50, 'Ensino Superior'), (60, 'Ensino Profissionalizante'), (70, 'Não há estabelecimento de ensino no PA')], null=True, verbose_name='Estabelecimento de ensino')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('fonte_agua', models.IntegerField(blank=True, choices=[(10, 'Poço artesiano'), (20, 'Nascente ou vertente'), (30, 'Córregos ou Rios'), (40, 'Capitação de água da chuva'), (50, 'Açude / Barreiro'), (60, 'Poço comum'), (70, 'Depósito coletivo'), (80, 'Rede de água encanada'), (90, 'Outra')], null=True, verbose_name='Fonte de água')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('tipo_atividade', models.IntegerField(blank=True, choices=[(10, 'Agropecuária'), (20, 'Irrigação'), (30, 'Aquicultura'), (40, 'Lazer e Turismo'), (50, 'Outros')], null=True, verbose_name='Tipo de atividade')),
                ('outros', models.CharField(blank=True, max_length=50, null=True, verbose_name='Outros (Especificar)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coordenada_x', models.CharField(max_length=30, verbose_name='Coordenada "X" (UTM)')),
                ('coordenada_y', models.CharField(max_length=30, verbose_name='Coordenada "Y" (UTM)')),
                ('banda_coordenada', models.CharField(blank=True, max_length=30, null=True, verbose_name='Banda')),
                ...
                ('ocupante_irregular', models.IntegerField(choices=[(10, 'Regular'), (20, 'Irregular'), (30, 'Bloqueado')], verbose_name='Status do Ocupante')),
                ...
                ('quantas_familias_utilizam_mesma_fonte_agua', models.IntegerField(choices=[(10, 'Nenhuma'), (20, 'Uma outra família, além da sua família'), (30, 'Mais de uma'), (40, 'Não se aplica')], verbose_name='15. Quantas famílias (além da sua) fazem o uso da mesma fonte de água que abastece o seu lote?')),
                ...
                ('possui_capineira', models.IntegerField(choices=[(1, 'Sim'), (0, 'Não')], default=0, verbose_name='Possui Capineira?')),
                ('area_pastejo_rotacionado', models.DecimalField(blank=True, decimal_places=4, max_digits=10, null=True, verbose_name='Tamanho da área em sistema de Pastejo Rotacionado (ha)')),
                ('necessita_licenciamento_ambiental', models.IntegerField(choices=[(1, 'Sim'), (0, 'Não')], default=0, verbose_name='Necessita de licenciamento ambiental de atividade?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parentesco', models.IntegerField(blank=True, choices=[(10, 'Titular'), (20, 'Cônjuge'), (30, 'Irmão(a)'), (40, 'Tio(a)'), (50, 'Primo(a)'), (60, 'Filho(a)'), (70, 'Enteado(a)'), (80, 'Cunhado(a)'), (90, 'Genro/Nora'), (100, 'Neto(a)'), (110, 'Agregado(a)')], null=True, verbose_name='Parentesco')),
                ('idade', models.IntegerField(blank=True, null=True, verbose_name='Idade')),
                ('escolaridade', models.IntegerField(blank=True, choices=[(10, '(a) Não alfabetizado'), (20, '(b) 1º ao 4º ano'), (30, '(c) 5º ao 9º ano'), (40, '(d) Fundamental completo'), (50, '(e) EJA - Educação de Jovens e Adultos'), (60, '(f) Médio incompleto'), (70, '(g) Médio completo'), (80, '(h) Superior incompleto'), (90, '(i) Superior completo'), (100, '(j) Pós Graduação incompleto'), (110, '(k) Pós Graduação completo')], null=True, verbose_name='Escolaridade')),
                ('estuda', models.IntegerField(blank=True, choices=[(1, 'Sim'), (0, 'Não')], null=True, verbose_name='Estuda?')),
                ...
                ('trabalho_fora_lote_quantidade_dias_ano', models.IntegerField(blank=True, null=True, verbose_name='Quantidade de dias/ano trabalha fora do lote')),
                ('trabalho_fora_lote_valor_diaria', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='Valor da Diária (R$/dia)')),
                ('uso_frequente_bebida_alcoolica', models.IntegerField(blank=True, choices=[(1, 'Sim'), (0, 'Não')], null=True, verbose_name='Bebidas alcoólicas')),
                ('uso_frequente_cigarro', models.IntegerField(blank=True, choices=[(1, 'Sim'), (0, 'Não')], null=True, verbose_name='Cigarros')),
                ('uso_frequente_remedios_alto_custo', models.IntegerField(blank=True, choices=[(1, 'Sim'), (0, 'Não')], null=True, verbose_name='Remédios de Alto Custo')),
                ('uso_frequente_outros', models.CharField(blank=True, max_length=30, null=True, verbose_name='Uso Frequente (Outros)')),
                ('opcao_ensino_utilizada', models.IntegerField(blank=True, choices=[(10, 'Frequenta escola em outro assentamento'), (20, 'Frequenta escola na cidade mais próxima'), (10, 'Deixa de frequentar a escola'), (10, 'Outros')], null=True, verbose_name='Opção de ensino utilizada')),
                ('opcao_ensino_utilizada_distancia_ate_escola', models.IntegerField(blank=True, null=True, verbose_name='Distância até a escola (Km)')),
                ('opcao_ensino_utilizada_oferta_de_transporte', models.IntegerField(blank=True, choices=[(1, 'Sim'), (0, 'Não')], null=True, verbose_name='Há oferta de transporte para a escola?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('tipo_capineira', models.IntegerField(blank=True, choices=[(10, 'Cana'), (20, 'Napier'), (99, 'Não se aplica')], null=True, verbose_name='Tipo de Capineira')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_criacao', models.IntegerField(blank=True, choices=[(1, 'Gado Leiteiro'), (2, 'Gado de Corte')], null=True, verbose_name='Tipo de criação')),
                ('especificacao', models.IntegerField(blank=True, choices=[(10, 'Touros'), (20, 'Vacas'), (30, 'Novilhas(os) + de 02 anos'), (40, 'Novilhas(os) + de 01 ano'), (50, 'Bezerras(os)'), (60, 'Boi'), (70, 'Frango de corte caipira'), (80, 'Galinha caipira (somente frangos(as) e adultos)'), (90, 'Suínos'), (100, 'Ovinos'), (110, 'Equinos / Muares'), (120, 'Caprinos'), (999, 'Outros')], null=True, verbose_name='Especificação')),
                ('quantidade_cabecas', models.IntegerField(blank=True, null=True, verbose_name='Nº de Cabeça(s)')),
                ('valor_cabeca', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='R$/Cabeça')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('especificacao', models.IntegerField(blank=True, choices=[(10, 'Eucalipto(m³)'), (20, 'Teca(m³)'), (30, 'Seringueira(Kg/látex)'), (40, 'Seringueira(m³/Madeira)'), (50, 'Outros')], null=True, verbose_name='Especificação')),
                ('outros', models.CharField(blank=True, max_length=30, null=True, verbose_name='Outros')),
                ('quantidade_produzida_ano', models.IntegerField(blank=True, null=True, verbose_name='Quantidade produzida/ano')),
                ('area_plantada', models.DecimalField(blank=True, decimal_places=4, max_digits=10, null=True, verbose_name='Área plantada (ha)')),
                ('valor', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='R$/Unidade colhida')),
                ('canal_comercializacao', models.IntegerField(blank=True, choices=[(10, '(1) Venda p/ indústrias de beneficiamento primário-madeira (serraria, laminadora) indústria de beneficiamento de borracha natural, etc'), (20, '(2) Venda para indústria de tratamento de madeira'), (30, '(3) Venda para setor de construção civil'), (30, '(3) Venda para setor de construção civil'), (40, '(4) Venda para agentes "atravessadores"'), (50, '(5) Outros')], null=True, verbose_name='Formas/Canais de Comercialização')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producao_unidade_medida', models.IntegerField(blank=True, choices=[(1, 'Kg'), (2, 'un')], null=True, verbose_name='Unidade de medida')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('classificacao', models.IntegerField(verbose_name='Classificação')),
                ('especificacao', models.IntegerField(blank=True, choices=[(10, 'Carne(Kg)'), (20, 'Leite(L)'), (30, 'Mel(Kg)'), (40, 'Ovos(Dz)'), (50, 'Peixes(Kg)'), (60, 'Banha(Kg)'), (70, 'Conservas(Un)'), (80, 'Doces(Un)'), (90, 'Farinha Mandioca(Kg'), (100, 'Linguiça(Kg)'), (110, 'Polvilho de Mandioca(Kg)'), (120, 'Queijo(Kg)'), (130, 'Rapadura(Kg)'), (999, 'Outros')], null=True, verbose_name='Especificação')),
                ('outros', models.CharField(blank=True, max_length=30, null=True, verbose_name='Outros (Especificar)')),
                ('producao_consumo', models.IntegerField(blank=True, null=True, verbose_name='Produção (Consumo)')),
                ('producao_comercio', models.IntegerField(blank=True, null=True, verbose_name='Produção (Comércio)')),
                ('valor', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='Valor R$')),
                ('canal_comercializacao', models.IntegerField(blank=True, choices=[(10, '(1) Venda direta ao consumidor (de casa em casa)'), (20, '(2) Venda em feiras'), (30, '(3) Entrega para supermercados, mercearias, açougues, etc'), (40, '(4) Venda p/ indústrias, e/ou agroindústrias (laticínios etc'), (50, '(5) Venda para agentes "atravessadores"'), (60, '(6) Outros')], null=True, verbose_name='Formas/Canais de Comercialização')),
                ('mercado_institucional', models.IntegerField(blank=True, choices=[(10, '(7) PAA-CONAB'), (20, '(8) PAA-Prefeitura / MDS'), (30, '(9) Alimentação Escolar - PNAE'), (40, '(10) Biodiesel'), (50, '(11) Outros')], null=True, verbose_name='Mercado Institucional')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('programa_saude', models.IntegerField(blank=True, choices=[(10, 'Programa Saúde da Família - PSF'), (20, 'Agentes Comunitários de Saúde'), (30, 'Atendimento médico'), (40, 'Atendimento odontológico'), (50, 'Campanha de vacinação'), (60, 'Saúde da Mulher')], null=True, verbose_name='Programa/Tipo de atendimento à saúde')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capacidade_projeto', models.PositiveIntegerField(verbose_name='Capacidade do Projeto')),
                ...
                ('contrato', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='projetos_assentamento', to='core.Contrato', verbose_name='Contrato')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modificado_em', models.DateTimeField(auto_now=True, null=True)),
                ('desativado_em', models.DateTimeField(blank=True, null=True)),
                ('tratamento_agua', models.IntegerField(blank=True, choices=[(10, 'Não há tratamento'), (20, 'Cloração'), (30, 'Fervura'), (40, 'Filtragem'), (50, 'Dessalinização'), (60, 'Outros')], null=True, verbose_name='Forma de tratamento')),
                ('outros', models.CharField(blank=True, max_length=30, null=True, verbose_name='Outros (Especificar)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospital', models.IntegerField(blank=True, choices=[(1, 'P.A'), (2, 'Cidade'), (3, 'Não se aplica')], null=True, verbose_name='Hospital')),
                ('posto_saude', models.IntegerField(blank=True, choices=[(1, 'P.A'), (2, 'Cidade'), (3, 'Não se aplica')], null=True, verbose_name='Posto de saúde')),
                ('farmacia', models.IntegerField(blank=True, choices=[(1, 'P.A'), (2, 'Cidade'), (3, 'Não se aplica')], null=True, verbose_name='Farmácia')),
                ('outros', models.IntegerField(blank=True, choices=[(1, 'P.A'), (2, 'Cidade'), (3, 'Não se aplica')], null=True, verbose_name='Outros')),
        ...
        migrations.AddField(
            model_name='membro',
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='membros', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='membro',
            name='modificado_por',
        ...
        migrations.AddField(
            ...
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='destinosMaterialOrganico', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='destinomaterialorganico',
            name='modificado_por',
        ...
        migrations.AddField(
            model_name='destinolixodomesticonaoorganico',
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='destinosLixoDomesticoNaoOrganico', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='destinolixodomesticonaoorganico',
            name='modificado_por',
            field=cuser.fields.CurrentUserField(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='core_destinolixodomesticonaoorganico_modificado_por', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='aguaparaanimaisplantio',
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='aguasParaAnimaisPlantio', to='core.Lote', verbose_name='Lote'),
        ),
        migrations.AddField(
            model_name='aguaparaanimaisplantio',
            name='modificado_por',
            field=cuser.fields.CurrentUserField(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='core_aguaparaanimaisplantio_modificado_por', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Bovinocultura',
            fields=[
